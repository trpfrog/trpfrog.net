---
title: 開通直前の多摩川スカイブリッジを渡ってきた
date: 2022-02-27
held: 2022-02-26
tags: 徒歩
description: ウォーキングイベントに参加して開通前の橋を渡ってきました。横浜観光もあるぞ！
thumbnail: https://res.cloudinary.com/trpfrog/image/upload/v1645889555/blog/skybridge-walk/286293B0-B889-48CF-921A-63D7007921BA_1_102_o.jpg
---

こんにちは、つまみです。今日は川崎側から羽田空港に直接かかる**開通前の**橋、**多摩川スカイブリッジ**を渡ってきました。
...
club: UEC19
twitter: TrpFrog
description: 開通前の橋渡りたすぎの会 所属、徒歩部ではない
---
name: きゅ〜
club: UEC19
twitter: kyu_099
...
面白いものがなすぎて**クソタイムラプスを撮る以外のことができなくなってしまいました……**
...
奥にも歩道橋が見えるのですが、これはもしかして**上が四角く繋がってるタイプの歩道橋**ですね！普通の歩道橋はもう飽きたので変わり種が出てくると嬉しくなります。
...
```twitter-archived
id: 1497387057521455104
name: つまみ
userid: TrpFrog
date: 2022-02-26
tweet: もしかして巨大ウォーキングイベント❓
```

```twitter-archived
id: 1497387489815793665
name: つまみ
userid: TrpFrog
date: 2022-02-26
tweet: 人多すぎ！早く知事エリアメール出して！
```

```twitter-archived
id: 1497387736768008194
name: つまみ
userid: TrpFrog
date: 2022-02-26
tweet: <b>「用紙が切れて行列が進まない」</b>らしい、最悪、撤退❗️
```
...
```twitter-archived
id: 1497393251849961475
name: ミノガメ
userid: sirominogame
date: 2022-02-26
color: darkgreen
tweet: 徒歩部が地元近く通っててうおおおってなってる
```
```twitter-archived
id: 1497393521048707072
name: つまみ
userid: TrpFrog
date: 2022-02-26
tweet: @sirominogame 歩け❗️
```
```twitter-archived
id: 1497393464040095745
name: きゅ〜
userid: kyu_099
date: 2022-02-26
color: darkred
...
```centering
「こっちに来ちゃダメだよ〜 こっちは**行き止まり**だよ〜」
```

という声がしました(したらしい)。**<span style="font-size: 1.5em">行き止まり！？！？！？</div>**
行き止まり同好会の出番が来ました。

<div style="height: 5em"></div>

```centering
**<span style="font-size: 2em">行くぜ！！！！！！！！！！</span>**
```
...
横浜に行きましょう！**電車で！** 徒歩部ではなく「開通前の橋渡りたすぎの会」なので歩きません。**そもそもこの辺歩道橋以外歩いてて面白いものない😅**
...
```twitter-archived
id: 1497435896828022785
name: gotti
userid: _nil_a_
date: 2022-02-26
color: linen
tweet: trpfrogに奢られたすぎ!
```
...
```conversation
B: (カメラ目線でピース)
おれ: おい！わざわざこっち向かなくてよろしい！
B: でもそっち向いたらモザイク編集が大変になるでしょ？😁
おれ: バカ
```
...
ということで桜木町駅につきました。そこそこ歩いて満足したので今日は帰りましょう！**明日スキー行くオタクがいるらしいし(え？)** 延長戦とかいうバカタレムーブで脚破壊してスキーできなくなったら悲しいですからね。もう帰ってください。

今日は

- 川崎から多摩川スカイブリッジを渡りに行く
- 横浜観光徒歩

をしました。春休み一発目の徒歩だったので**若干脚が弱ってる感**を感じたものの、楽しい徒歩ができたので良かったです。

それではまた次回の徒歩会でお会いしましょう！さようなら
