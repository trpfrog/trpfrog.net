...
export default function PageNavigation(props: {
  ...
  return (
    <div className={styles.navigation}>
      <span style={{display: 'inline-block'}}>{props.numTweets} ツイート中 {tweetRemains} 件を表示</span>{' '}
      <span style={{display: 'inline-block'}}>({props.currentPage} / {props.lastPage} ページ目)</span>
