...
const styles = tv({
  slots: {
    ...
    bgImage: `tw:absolute tw:left-0 tw:top-0 tw:h-full tw:w-full tw:-skew-x-12 tw:skew-y-6 tw:scale-110 tw:bg-cover tw:bg-center tw:bg-no-repeat`,
    text: `tw:flex tw:h-full tw:w-full tw:flex-col tw:items-center tw:justify-center tw:bg-black/60 tw:text-center tw:text-white`,
  },
})()
