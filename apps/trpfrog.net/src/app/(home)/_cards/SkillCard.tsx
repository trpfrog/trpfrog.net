...
const styles = tv({
  slots: {
    ...
    icon: [
      ...
      'tw:relative tw:top-1.5 tw:drop-shadow-sm tw:sp:top-0',
    ],
  ...
  return (
    ...
    >
      <Skill
        ...
        className="tw:bg-linear-to-br tw:from-blue-500 tw:to-blue-600 tw:text-white"
      />
      <Skill
        title="React"
        description={['頻繁に使う', 'Next.js とよく使う']}
        icon={<Devicon iconName="React" />}
        className="tw:bg-linear-to-br tw:from-cyan-500 tw:to-cyan-600 tw:text-white"
      />
      <Skill
        title="HTML/CSS"
        description="大学1年の頃からずっと書いている"
        icon={<Devicon iconName="HTML" />}
        className="tw:bg-linear-to-br tw:from-amber-500 tw:to-amber-600 tw:text-white"
      />
      <Skill
        title="Python"
        description={['研究でよく使う', 'PyTorch など']}
        icon={<Devicon iconName="Python" />}
        className="tw:bg-linear-to-br tw:from-lime-600 tw:to-lime-700 tw:text-white"
      />
      <Skill
        title="C++"
        description={['競プロで使った', '業プロは厳しそう']}
        icon={<Devicon iconName="C++" />}
        className="tw:bg-linear-to-br tw:from-violet-500 tw:to-violet-600 tw:text-white"
      />
      <Skill
        title="Java"
